...
public class Engine : MonoBehaviour
{
	...
	const string stopword = "asd3dfhjk7";
    ...
    class Root
    {
		public string hioasjndof;
        public string ashkasc;
        public string asddshjhj;
        public string bnniuans;
        public string halhok;
        public string hgalskd;
        public string haskmd;
		...
		{
			return !string.Join(hioasjndof, ashkasc, asddshjhj, bnniuans, halhok, hgalskd, haskmd).Contains(stopword);
		}
    }
}
